...
def test():
    ...
    try:
        ...
        spi = SPI(1, baudrate=10000000, sck=Pin(14), mosi=Pin(15), miso=Pin(12))
        display = Display(spi, dc=Pin(4), cs=Pin(5), rst=Pin(2))
#        spi = SPI(0, 10000000, sck=Pin(2), mosi=Pin(3), miso=Pin(4))
#        display = Display(spi, dc=Pin(14), cs=Pin(5), rst=Pin(15))
        display.clear()
